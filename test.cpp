...
int main(){
    ...
    */
    ...
    list<string> ObjectFunctionNames{ "ExtSurfaceEExp"};
    
    double exponent = 2;

    list<double> ObjectParameter1{focus, exponent};
    ...
    string save_position="./275thick-ExtSurfaceEExp-1975area-focus500-GPU/";

    
    EvoModel TestModel(&ObjectFunctionNames, &ObjectParameters, HavePenalty, PenaltyFactor, save_position, &S, d, lam, n_K, E0, n_E0, material);
