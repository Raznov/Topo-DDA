...
//periodic PointE design with substrate new
int main() {

    string save_position = ".\\200nm3-Air-TiN-PointE7-lam500-period-ones-2D-new\\";       //output file
    Vector3d l;
    Vector3d center;
    l << 19.0, 19.0, 19.0;    //Size of the initialization block. 81*81*17 pixels in total.
    center << l(0) / 2, l(1) / 2, l(2) / 2;      //Center of the block.
    ...
    list<VectorXi*> FPGeometryl{ s1geometry };
    list<VectorXi*> BPGeometryl{ s2geometry };
    list<double> BParal{ 1.0 };
...
//periodic PointE design 3 layer
int main() {
